...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  std::cout << "X_car: " << solution.x[x_start] << std::endl;
  std::cout << "Y_car: " << solution.x[y_start] << std::endl;
  std::cout << "CTE: " << solution.x[cte_start] << std::endl;
  std::cout << "Epsi " << solution.x[epsi_start] << std::endl;
